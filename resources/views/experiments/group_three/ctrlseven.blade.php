...
<div class="row plast">
  ...
  <form action="ctrlseveninsert" methood="get">
  ...
  <div class="row plast">
    <div class="bottle col-sm-3"><button name="bottle" value="bottle 4"><img src="images/bottle4.jpg" class="bottle" alt="slika"></button></div>
    <div class="bottle col-sm-3"><button name="bottle" value="bottle 5"><img src="images/bottle5.jpg" class="bottle" alt="slika"></button></div>
    <div class="bottle col-sm-3"><button name="bottle" value="bottle 6"><img src="images/bottle6.jpg" class="bottle" alt="slika"></button></div>
    <div class="bottle col-sm-3"><button name="bottle" value="bottle 7"><img src="images/bottle7.jpg" class="bottle" alt="slika"></button></div>
  </form>
