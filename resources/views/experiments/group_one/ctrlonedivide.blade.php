...
<div class="row plast">
  ...
  <form id="ctrloneinsert" action="ctrloneinsert" methood="get">
    <div class="bottle col-sm-4"><img src="images/bottle.jpg" class="bottle" alt="slika">
  ...
  <div class="row plast">
    <div class="bottle col-sm-3"><img src="images/bottle.jpg" class="bottle" alt="slika">
